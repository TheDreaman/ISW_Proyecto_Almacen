...
namespace Presentacion {
    ...
    public partial class UsersTable : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsersRow AddUsersRow(int Matricula, string UserName, string Password, string Name1, string Apellido, string Rol, string Email, byte[] Picture, string Cargo) {
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public int Matricula {
                get {
                    return ((int)(this[this.tableUsers.MatriculaColumn]));
                }
                set {
                    this[this.tableUsers.MatriculaColumn] = value;
                }
            }
            ...
            public string Name1 {
                get {
                    return ((string)(this[this.tableUsers.Name1Column]));
                }
                set {
                    this[this.tableUsers.Name1Column] = value;
                }
            }
            ...
            public byte[] Picture {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Picture\' de la tabla \'Users\' es DBNull.", e);
                    }
                }
                set {
...
namespace Presentacion.UsersTableTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([ID] = @Original_ID) AND ([Matricula] = @Original_Matricula) AND ([UserName] = @Original_UserName) AND ([Password] = @Original_Password) AND ([Name1] = @Original_Name1) AND ([Apellido] = @Original_Apellido) AND ([Rol] = @Original_Rol) AND ([Email] = @Original_Email) AND ([Cargo] = @Original_Cargo))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([Matricula], [UserName], [Password], [Name1], [Apellido], [Rol], [Email], [Picture], [Cargo]) VALUES (@Matricula, @UserName, @Password, @Name1, @Apellido, @Rol, @Email, @Picture, @Cargo);
SELECT ID, Matricula, UserName, Password, Name1, Apellido, Rol, Email, Picture, Cargo FROM Users WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Matricula] = @Matricula, [UserName] = @UserName, [Password] = @Password, [Name1] = @Name1, [Apellido] = @Apellido, [Rol] = @Rol, [Email] = @Email, [Picture] = @Picture, [Cargo] = @Cargo WHERE (([ID] = @Original_ID) AND ([Matricula] = @Original_Matricula) AND ([UserName] = @Original_UserName) AND ([Password] = @Original_Password) AND ([Name1] = @Original_Name1) AND ([Apellido] = @Original_Apellido) AND ([Rol] = @Original_Rol) AND ([Email] = @Original_Email) AND ([Cargo] = @Original_Cargo));
SELECT ID, Matricula, UserName, Password, Name1, Apellido, Rol, Email, Picture, Cargo FROM Users WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Matricula, UserName, Password, Name1, Apellido, Rol, Email, Picture, C" +
                "argo FROM dbo.Users";
        ...
        public virtual int Delete(int Original_ID, int Original_Matricula, string Original_UserName, string Original_Password, string Original_Name1, string Original_Apellido, string Original_Rol, string Original_Email, string Original_Cargo) {
            ...
            if ((Original_Name1 == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_Name1));
            }
        ...
        public virtual int Insert(int Matricula, string UserName, string Password, string Name1, string Apellido, string Rol, string Email, byte[] Picture, string Cargo) {
        ...
        public virtual int Update(
                    ...
                    string Original_Email, 
                    string Original_Cargo) {
            return this.Update(Matricula, UserName, Password, Name1, Apellido, Rol, Email, Picture, Cargo, Original_ID, Original_Matricula, Original_UserName, Original_Password, Original_Name1, Original_Apellido, Original_Rol, Original_Email, Original_Cargo, Original_ID);
        }
    }
